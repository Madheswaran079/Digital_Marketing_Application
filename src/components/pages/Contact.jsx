      ...
      <div style={{ display: "flex", flexWrap: "wrap" }}>
            ...
            <CardActionArea>
              ...
              <CardContent>
                ...
                <Typography variant="body2" color="text.secondary">
                  digixbusiness@gmail.com
                </Typography>
              </CardContent>
            </CardActionArea>
            <CardActions>
              <a
                href={"mailto:digixbusiness@gmail.com"}
                target="_blank"
                rel="noreferrer"
              >
        ...
        <div style={{ padding: "30px" }} className="card">
          <Card elevation={24} sx={{ width: 200 }}>
            ...
            <CardActions>
              <a href={"tel:9080896606"} target="_blank" rel="noreferrer">
                <Button size="small" color="primary">
                  Call
                </Button>
              </a>
        ...
        <div style={{ paddingTop: "30px", padding: "30px" }} className="card">
          <Card elevation={24} sx={{ width: 200 }}>
            <CardActionArea>
              <CardMedia
                component="img"
